...
Cada categoria de vulnerabilidade descrita nas seções anteriores possui mecanismos de defesa específicos, com diferentes níveis de efetividade e limitações. A Tabela \ref{tab:tecnicas_defesa} consolida a relação entre técnicas de defesa, ataques mitigados e suas restrições, com base em trabalhos de classificação como os de \cite{Halfond2006SQLInjectionClassification}, \cite{Gupta2015XSSAttacksDefense}, \cite{Barth2008RobustDefensesCSRF} e \cite{OWASP2021Top10}.
